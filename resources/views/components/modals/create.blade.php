<div id="upload-modal" class="fixed inset-0 bg-black bg-black/75 flex items-center justify-center z-50 hidden opacity-0">
    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-sm relative transform scale-95">
        ...
        <form id="create-post-form">
            ...
            <div class="relative flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 rounded-xl hover:border-indigo-400 transition cursor-pointer group h-48">
                ...
                <div id="upload-placeholder" class="text-center">
                    ...
                    <p class="text-indigo-600 font-semibold text-lg">Select your image</p>
            ...
            <div class="mt-4">
                ...
                <textarea
                    id="post-caption"
                    rows="3"
                    class="w-full p-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition resize-none shadow-sm"
            ...
            <button type="submit" id="publish-button" class="w-full mt-6 bg-indigo-600 text-white py-2 rounded-lg font-semibold opacity-70 transition duration-150 shadow-md">
                Upload & Publish
            </button>
        </form>
    </div>
